...
**⚠️ The dev AWS SES keys are currently rejected** (`UnrecognizedClientException`),
so nothing can actually be emailed until the owner creates new keys. Feature work
is not blocked — see PROGRESS.md.
